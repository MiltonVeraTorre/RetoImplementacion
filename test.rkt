...
(define (es_D tokens indice)
  (if (>= indice (length tokens)) ; Verificamos si la longitud es mayor que la de la lista
      ...
      (case (car (list-ref tokens indice)) ; Verificamos si se cumple alguno de los casos definidos en la gramatica
        ...
        [(KEYWORD) (es_F tokens (+ indice 1))] ; Verificamos si se trata de una función
        [(KEYWORD) (es_C tokens (+ indice 1))] ; Verificamos si se trata de un ciclo
        [(COMMENT) (es_COM tokens (+ indice 1))] ; Verificamos si se trata de un comentario
        [(NEWLINE) (es_D tokens (+ indice 1))] ; Si se trata de un espacio en blanco volvemos a llamar a es_D
  ...
  (if (>= indice (length tokens)) ; Verificamos si se sobrepasa la longitud
      ...
      (let 
        ...
        (if (and 
                 ...
                 (eq? (car (list-ref tokens (+ indice 1))) IDENTIFIER)  ; Luego verificamos si hay un identificador
                 (eq? (car (list-ref tokens (+ indice 2))) OPERATOR) ; Posteriormente debe de haber un operador
...
(print (es_P 
    ...
    (cons KEYWORD "let") (cons IDENTIFIER "a") (cons OPERATOR "=") (cons NUMBER "5") (cons NEWLINE "\r\n") 
    (cons KEYWORD "let") (cons IDENTIFIER "b") (cons OPERATOR "=") (cons NUMBER "10") (cons NEWLINE "\r\n") 
    (cons KEYWORD "let") (cons IDENTIFIER "c") (cons OPERATOR "=") (cons NUMBER "30") (cons OPERATOR "+") (cons NUMBER "20") (cons NEWLINE "\r\n") 
    (cons NEWLINE "\r\n") 
    (cons KEYWORD "for") (cons LEFT_PARENTHESIS "(") (cons KEYWORD "let") (cons IDENTIFIER "i") (cons OPERATOR "=") (cons NUMBER "5") (cons SEMICOLON ";") 
    ...
    (cons KEYWORD "let") (cons IDENTIFIER "c") (cons OPERATOR "=") (cons NUMBER "3") (cons NEWLINE "\r\n") 
    (cons IDENTIFIER "c") (cons OPERATOR "=") (cons IDENTIFIER "i") (cons OPERATOR "+") (cons NUMBER "3") (cons NEWLINE "\r\n") 
    (cons NEWLINE "\r\n") 
    (cons RIGHT_BRACE "}") 
    (cons NEWLINE "\r\n") 
    (cons NEWLINE "\r\n") 
    (cons KEYWORD "function") (cons IDENTIFIER "prueba") (cons LEFT_PARENTHESIS "(") (cons IDENTIFIER "a") (cons SEPARATOR ",") (cons IDENTIFIER "b") (cons RIGHT_PARENTHESIS ")") (cons LEFT_BRACE "{") (cons NEWLINE "\r\n") 
    (cons KEYWORD "return") (cons IDENTIFIER "a") (cons OPERATOR "+") (cons IDENTIFIER "b") (cons NEWLINE "\r\n") 
    (cons RIGHT_BRACE "}") (cons NEWLINE "\r\n") 
    (cons NEWLINE "\r\n") 
    (cons KEYWORD "while") (cons LEFT_PARENTHESIS "(") (cons IDENTIFIER "a") (cons OPERATOR ">") (cons NUMBER "2") (cons RIGHT_PARENTHESIS ")") (cons LEFT_BRACE "{") (cons NEWLINE "\r\n") 
    (cons KEYWORD "let") (cons IDENTIFIER "z") (cons OPERATOR "=") (cons IDENTIFIER "z") (cons OPERATOR "+") (cons IDENTIFIER "a") (cons NEWLINE "\r\n") 
    (cons RIGHT_BRACE "}") 
    (cons NEWLINE "\r\n") 
    (cons NEWLINE "\r\n")
    )
